package org.berry.ui.login;

import org.berry.R;
import org.berry.bean.AccountBean;
import org.berry.support.database.AccountDBTask;
import org.berry.support.lib.changelogdialog.ChangeLogDialog;
...
public class AccountActivity extends AbstractAppActivity
    ...
    private static final String ACTION_OPEN_FROM_APP_INNER = "org.berry:accountactivity";
