...
import org.berry.dao.send.RepostNewMsgDao;
import org.berry.othercomponent.sendweiboservice.SendCommentService;
import org.berry.othercomponent.sendweiboservice.SendRepostService;
import org.berry.support.database.DraftDBManager;
import org.berry.support.database.draftbean.CommentDraftBean;
...
public class WriteCommentActivity extends AbstractWriteActivity<ItemBean> {
    ...
    public static final String ACTION_DRAFT = "org.berry.DRAFT";
    public static final String ACTION_SEND_FAILED = "org.berry.SEND_FAILED";
