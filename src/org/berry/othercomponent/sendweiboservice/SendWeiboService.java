package org.berry.othercomponent.sendweiboservice;
...
import org.berry.dao.send.StatusNewMsgDao;
    ...
    private class WeiboSendTask extends MyAsyncTask<Void, Long, Void> {
        ...
        protected void onPreExecute() {
            ...
            if (Utility.isJB()) {
                ...
                IntentFilter intentFilter = new IntentFilter("org.berry.SendWeiboService.stop." + String.valueOf(notificationId));

                registerReceiver(receiver, intentFilter);

                Intent broadcastIntent = new Intent("org.berry.SendWeiboService.stop." + String.valueOf(notificationId));
